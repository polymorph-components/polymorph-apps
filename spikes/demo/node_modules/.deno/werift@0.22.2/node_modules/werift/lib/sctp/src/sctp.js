...
class SCTP {
    constructor(transport, port = 5000) {
        ...
        Object.defineProperty(this, "send", {
            ...
            value: async (streamId, ppId, userData, { expiry, maxRetransmits, ordered, } = { expiry: undefined, maxRetransmits: undefined, ordered: true }) => {
                ...
                let pos = 0;
                const chunks = [];
                for (const fragment of (0, range_js_1.default)(0, fragments)) {
    ...
    async receiveSackChunk(chunk) {
        ...
        if (chunk.gaps.length > 0) {
            const seen = new Set();
            let highestSeenTsn;
            chunk.gaps.forEach((gap) => (0, range_js_1.default)(gap[0], gap[1] + 1).forEach((pos) => {
    ...
    maybeAbandon(chunk) {
        ...
        for (const pos of (0, range_js_1.default)(chunkPos, -1, -1)) {
        ...
        for (const pos of (0, range_js_1.default)(chunkPos, this.sentQueue.length)) {
            const oChunk = this.sentQueue[pos];
            oChunk.abandoned = true;
            oChunk.retransmit = false;
            if (oChunk.flags & SCTP_DATA_LAST_FRAG) {
