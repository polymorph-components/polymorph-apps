 ...
 * @returns {Buffer}
 */
declare function hmac(algorithm: string, secret: Buffer, data: Buffer): Buffer<ArrayBufferLike>;
/**
 ...
 * @returns {Buffer}
 */
declare function pHash(bytes: number, algorithm: string, secret: Buffer, seed: Buffer): Buffer<ArrayBuffer>;
export { hmac, pHash };
